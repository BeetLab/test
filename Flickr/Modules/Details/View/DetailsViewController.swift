...
class DetailsViewController: UIViewController {
    ...
    init(viewModel: DetailsViewModel, router: RouterProtocol) {
    ...
    func setupView() {
        ...
        isFriend.text = "Is Friend: \(String(self.viewModel.photo!.isfriend))"
        isFamily.text = "Is Family: \(String(self.viewModel.photo!.isfamily))"
